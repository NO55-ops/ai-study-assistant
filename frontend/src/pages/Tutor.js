...
const Tutor = () => {
  ...
  const selectedDocument = documents.find((doc) => doc.id === selectedDoc) || null;

  return (
    <div className="min-h-screen noise-overlay" style={{ background: 'var(--bg-main)' }}>
      <StudyWorkspace
        document={selectedDocument}
        title={selectedDocument ? selectedDocument.original_filename : 'No document selected'}
        subtitle="Study with the source material visible while you ask the tutor questions."
      >
